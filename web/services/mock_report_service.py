...
looking forward to supporting them next year.</b>"""
    ...
    def generate_email_template(self, student: Dict[str, Any]) -> str:
        ...
        email = f"""Subject: Your ASET Mock Exam Performance Report - {student['name']}

Dear Parents/Guardians of {student['name']},

Thank you for having your child participate in our ASET Mock Examination. We are pleased to share their performance report.

Results Summary:
-----------------
Reading Comprehension: {student['reading']:.2f}
Communicating Ideas in Writing: {student['writing']:.2f}
Quantitative Reasoning: {student['qr']:.2f}
Abstract Reasoning: {student['ar']:.2f}
Total Standard Score: {student['total']:.2f}

Please find attached a detailed performance report PDF that includes:
• A comprehensive breakdown of scores in each section
• Comparison with 2025 WA minimum and maximum scores
• Concept-by-concept analysis for Reading and Quantitative Reasoning
• Tips and strategies for improvement in each area
• Information about our upcoming GATE preparation classes

Important Reminders:
-------------------
• This mock exam is a diagnostic tool to identify areas for improvement
• There is still time before the real ASET exam to make significant progress
• Consistent practice with the right strategies leads to improvement

Our GATE classes will resume in January for the GATE HOLIDAY MASTERCLASS during the week of 19th - 25th Jan & 27th Jan - Feb 1st. We also have weekly classes from Term 1 2026 from the week of Feb 2nd - Feb 8th.

If you'd like your child to continue, please let us know at your earliest convenience so we can confirm their place.

If you have any questions about the report or need additional support, please don't hesitate to contact us.

Warm regards,
Everest Tutoring Team

---
This is an automated email. The attached report has been generated based on mock exam performance.
"""
        return email
